    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 992px) {
            ...
            .book-stage { padding: 24px 14px; }
            .book-viewport { height: auto; perspective: none; }
            .book-wrapper { height: auto; box-shadow: 0 24px 70px rgba(0,0,0,0.75), 0 0 40px rgba(212,175,55,0.12); }
            .book-spread { position: relative; height: auto; opacity: 1; display: none; flex-direction: column; gap: 20px; padding: 4px 0; }
            .book-spread.active { display: flex; }
            .book-page { width: 100%; min-height: 56vh; overflow: visible; padding: 28px 22px 20px 22px; }
            .book-page.left-page, .book-page.right-page {
                border-radius: 14px;
                border: 1px solid rgba(212,175,55,0.22);
                border-left: 1px solid rgba(212,175,55,0.22);
                border-right: 1px solid rgba(212,175,55,0.22);
            }
            .book-mini-item { height: 118px; }
            .book-mini-grid { grid-template-columns: repeat(2, 1fr); }
            .mag-grid-featured { grid-template-columns: 1fr; max-width: 540px; margin: 0 auto; }
            .mag-card .card-img-holder { height: 230px; }
        ...
        @media (max-width: 768px) {
            ...
            .hero-content h2 { font-size: 2.2rem; letter-spacing: 4px; }
            .hero-content p { font-size: 0.92rem; }
            .cover-title { font-size: 2rem; letter-spacing: 3px; }
            .cover-title span { letter-spacing: 6px; font-size: 1.1rem; }
            .cover-frame { inset: 10px; gap: 12px; }
            .mag-card .card-img-holder { height: 200px; }
            .lightbox-modal { padding: 12px; align-items: flex-start; overflow-y: auto; }
            ...
            .footer-logo { font-size: 1.6rem; letter-spacing: 3px; }
            .footer-contacts { gap: 18px; font-size: 0.9rem; }
        }
        ...
        @media (max-width: 480px) {
            ...
            .hero-content h2 { font-size: 1.75rem; letter-spacing: 3px; }
            .hero-content p { font-size: 0.85rem; }
            .hero-eyebrow { font-size: 0.7rem; }
            .section-header h2 { font-size: 1.4rem; }
            .cover-title { font-size: 1.7rem; }
            .cover-title span { font-size: 1rem; letter-spacing: 4px; }
            .mag-card .card-img-holder { height: 175px; }
            .mag-card .card-body { padding: 16px 16px 18px 16px; }
            .gallery-item .shape-container { height: 200px; }
            .gallery-item .specs-grid { grid-template-columns: repeat(2, 1fr); }
